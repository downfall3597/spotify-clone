...
<script>
    ...
    function setRepeat() {
        repeat = !repeat;
        var repeatImage = repeat ? "repeat-active" : "repeat";
        $(".controlButton.repeat img").attr("src", "assets/images/icons/" + repeatImage + ".png");
    }

    function setMute() {
        audioElement.audio.muted = !audioElement.audio.muted;
        var volumeImage = audioElement.audio.muted ? "volume-mute" : "volume";
        $(".controlButton.volume img").attr("src", "assets/images/icons/" + volumeImage + ".png");
    }

    function setShuffle() {
        shuffle = !shuffle;
        var shuffleImage = shuffle ? "shuffle-active" : "shuffle";
        $(".controlButton.shuffle img").attr("src", "assets/images/icons/" + shuffleImage + ".png");
        if (shuffle == true) {
    ...
    function setTrack(trackId, newPlaylist, play) {
        ...
        $.post("includes/handlers/ajax/getSong.php", {
            songId: trackId
        }, (data) => {
            var track = JSON.parse(data);
            $(".trackName span").text(track.title);
            $.post("includes/handlers/ajax/getArtist.php", {
                artistId: track.artist
            }, (data) => {
                var artist = JSON.parse(data);
                $(".artistName span").text(artist.name);
            });
            $.post("includes/handlers/ajax/getAlbum.php", {
                albumId: track.album
            }, (data) => {
